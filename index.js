...
const HeaderSidebar = document.querySelector('.header-menu');
...
function sidebarAnimation() {
    if (!isSidebarOpen) {
        gsap.to('.header-sidebar-block', { yPercent: 0, autoAlpha: 1, display:"block" });
...
HeaderSidebar.addEventListener("click", sidebarAnimation);
...
mm.add("(min-width: 769px)", function () {
    ...
    space02.to('.space02-inner', {
        ease: "none",
        x: function () {
            return document.querySelector('.sec-space02').offsetWidth - document.querySelector('.space02-inner').offsetWidth;
        }
    });
    ...
    Studio.to('.studio-inner', {
        ease: "none",
        x: function () {
            return document.querySelector('.sec-studio').offsetWidth - document.querySelector('.studio-inner').offsetWidth
        }
    });
